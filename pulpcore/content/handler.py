...
"""
    ...
    async def _serve_content_artifact(
        ...
        # RFC 9110 §14.2: If-Modified-Since is evaluated as if Range were absent. Matching IMS
        # must 304, not 416. When the cache is on, skip the handler 304 so Redis can store a 200.
